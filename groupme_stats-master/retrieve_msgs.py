...
parser.add_argument('-c', '--csv', help='Name of csv file to write to.', default='temp1.csv')
parser.add_argument('-o', '--overwrite', help='overwrite csv file', action="store_true", default=True)
...
def countMsgs(group_name, group_id, direct_msgs, csv_file=None, processTextFunc=None, sinceTs=datetime.datetime('2017-10-12 12:49:33')):
	"""
...
if __name__ == "__main__":
	...
	main(args.all, args.dm, b'FooBar the Company', args.csv, args.overwrite)
